...
import { applyReshuffle, resetItineraryData } from '../models/itineraryData.js';
      ...
      <aside class="sidebar-drawer" role="dialog" aria-label="Trip Navigation Menu" aria-modal="true">
        ...
        <div class="sidebar-body">
          ...
          <div class="sidebar-section">
            ...
            <!-- Reset Trip Action in Sidebar -->
            <div class="sidebar-reset-row">
              <button type="button" class="sidebar-reset-btn" id="sidebar-btn-reset-trip">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path>
                  <path d="M3 3v5h5"></path>
                </svg>
                <span>Reset Trip to Defaults</span>
              </button>
            </div>
          </div>
        </div>
